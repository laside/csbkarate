...
--   SECTION 1 — SCHÉMA : rejoue les migrations 0001 → 0015 (recrée tout propre).
...
-- =============================================================================
-- SECTION 1 — SCHEMA (migrations 0001 -> 0015, rejouees dans l ordre)
-- =============================================================================
...
-- =============================================================================
-- SECTION 2 — SEED SAISON V2.0 (coursType + tarifLicence)
-- =============================================================================
-- La migration 0005 a inséré la saison SANS `coursType` ni `tarifLicence`.
-- On réécrit ici le document avec ces champs, pour que l'inscription en ligne
-- (inscription.js) ET la création de dossier bureau (membres.js) calculent
-- les tarifs depuis la saison plutôt que depuis les valeurs codées en dur.
--   • `coursType` relie chaque ligne tarif au type de cours du formulaire.
--   • `prix` reste le tarif COURS SEUL (la licence est ajoutée par-dessus).
--   • `tarifLicence` = licence FFK en CENTIMES (3700 = 37 €).
update public.saison set data = $json$
{
    "label": "2026/2027",
    "debut": "2026-09-01",
    "fin": "2027-06-30",
    "horaires": [
        { "groupe": "Baby Karaté & Enfants (Gr. 1)", "lieu": "Gymnase Auguste Delaune", "jours": "Mardi et Jeudi",      "heures": "18h30 - 19h30", "accent": "dojo" },
        { "groupe": "Toutes cat. (sauf Baby) - Gr. 2", "lieu": "École Louise Michel",    "jours": "Lundi et Vendredi",   "heures": "18h00 - 19h00", "accent": "dojo" },
        { "groupe": "Ados & Adultes (dès 2011)",       "lieu": "Gymnase Auguste Delaune", "jours": "Mardi et Jeudi",      "heures": "19h30 - 21h00", "accent": "dojo" },
        { "groupe": "Self-Défense Féminine",           "lieu": "Gymnase Auguste Delaune", "jours": "Dimanche",            "heures": "11h00 - 12h30", "accent": "corail" }
    ],
    "tarifs": [
        { "coursType": "Baby",         "label": "Baby Karaté",           "prix": "183 €" },
        { "coursType": "Enfant",       "label": "Enfants",               "prix": "203 €" },
        { "coursType": "Adulte",       "label": "Ados / Adultes",        "prix": "233 €" },
        { "coursType": "Self-Defense", "label": "Self-Défense Féminine", "prix": "133 €" }
    ],
    "tarifsNote": "Des remises familles sont appliquées (de -10€ à -70€ selon le nombre d'inscrits).",
    "licenceNote": "* Prévoir 37€ supplémentaires pour la licence FFK.",
    "tarifLicence": 3700
