...
**Module Gestion de club (branche `feature-gestion`) — EN COURS :** `inscription.html` (Phase 1 livrée) et `membres.html` (Phase 2 livrée : CRM + fiche dossier famille avec règlements et validation des pièces). Détail complet dans la section dédiée plus bas.
